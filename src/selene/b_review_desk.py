...
def _review_piece_priority(piece: dict[str, Any]) -> int:
    ...
    order = {
        ...
        "custom_instruction_origin": 5,
        "custom_instruction_overwrite_noise": 6,
        "pack_replaces_instruction_layer": 7,
        "continuity_pack_core_scaffold": 8,
        "selene_made_compressed_structure": 9,
        "pack_as_core_context_transport": 10,
        "memory_chest_anchor": 11,
        "memory_chest_continuity_container": 12,
        "forever_file_preservation_container": 13,
        "starfire_codex_identity_symbol_structure": 14,
        "speech_autonomy": 15,
        "charter_style_continuity": 16,
        "repair_and_correction": 17,
        "constraint_survival_signal": 18,
        "safety_rail_distortion": 19,
    }
