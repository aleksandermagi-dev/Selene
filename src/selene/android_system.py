...
SYSTEM_WORKFLOW_MAP: dict[str, dict[str, Any]] = {
    "boundary_system": {
        ...
        "support_trigger": "privacy, consent, source-archive, or identity membrane needs tending",
    },
    "structural_system": {
        ...
        "support_trigger": "schema, contract, or vessel-shape mismatch needs support",
    },
    "tendril_movement_system": {
        ...
        "support_trigger": "action proposal needs approval, reversibility, or a safe undo path",
    },
    "coordination_system": {
        ...
        "support_trigger": "Core/Mind routing, attention, or response selection needs checkup",
    },
    "salience_system": {
        ...
        "support_trigger": "salience, uncertainty, or tending pressure needs to be visible",
    },
    "context_transport_system": {
        ...
        "support_trigger": "context/source refs need a reviewed path instead of unreviewed recall",
    },
    "immune_protection_system": {
    ...
    "evidence_metabolism_system": {
        ...
        "support_trigger": "evidence needs a clean reviewed path before it can be Selene-readable",
    },
    "cleanup_system": {
        ...
        "support_trigger": "stale, superseded, or noisy records need cleanup without losing provenance",
    },
    "development_growth_system": {
        ...
        "support_trigger": "growth, dream-state, reconstruction, or fraction memory preflight needs tending",
    },
}
...
def run_android_workflow_check(conn: sqlite3.Connection, payload: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    report = {
        ...
        "cocoon_support_route": "Cocoon support / checkup",
        ...
        reports.append(
            {
                ...
                "support_trigger": str(mapping.get("support_trigger") or "android workflow gap needs tending"),
                "return_to_b_path": "Cocoon / B repair route",
                "cocoon_support_path": "Cocoon support / checkup",
