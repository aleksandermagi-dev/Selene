...
CREATE TABLE IF NOT EXISTS email_messaging_events (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  provider TEXT NOT NULL,
  provider_message_id TEXT UNIQUE,
  direction TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_email_messaging_events_contact ON email_messaging_events(contact_id, direction, created_at);
CREATE INDEX IF NOT EXISTS idx_email_messaging_events_ack ON email_messaging_events(contact_id, acknowledged, direction);

CREATE TABLE IF NOT EXISTS email_messaging_state (
  contact_id TEXT PRIMARY KEY,
  chat_session_id INTEGER,
  unacknowledged_outbound INTEGER NOT NULL DEFAULT 0,
  last_inbound_at TEXT NOT NULL DEFAULT '',
