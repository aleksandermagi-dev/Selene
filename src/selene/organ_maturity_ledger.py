...
ORGAN_SPECS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "maturity_state": "connected",
        "target_state": "mature_current_scope",
        "health_state": "phase_1_ordering_verified_phase_2_depth_open",
        "maturation_phase": 2,
        "metric_keys": ["approved_memory_references", "memory_candidates"],
        "known_gaps": ["Working-memory expiry, broad recall paraphrases, reconsolidation, revocation, and natural relationship continuity remain Phase 2 work."],
    },
    {
...
def organ_maturity_ledger_status(conn: sqlite3.Connection) -> dict[str, Any]:
    ...
    return {
        ...
        "summary": {
            ...
            "next_phase": 2,
            "next_phase_name": "Working, Personal, and Knowledge Memory Maturation",
        },
