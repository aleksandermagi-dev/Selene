...
ORGAN_SPECS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "target_state": "mature_current_scope",
        "health_state": "phase_5_provisional_reasoning_and_stopping_gate_verified",
        "maturation_phase": 5,
    ...
    },
    {
        ...
        "maturity_state": "mature_current_scope",
        "target_state": "mature_current_scope",
        "health_state": "phase_5_typed_owner_and_terminal_receipt_gate_verified",
        "maturation_phase": 5,
        "metric_keys": [],
        "known_gaps": ["Answer breadth remains bounded by connected domain owners, attributed sources, and approved taught knowledge."],
    },
    {
        ...
        "maturity_state": "mature_current_scope",
        "target_state": "mature_current_scope",
        "health_state": "phase_5_changed_retry_and_bounded_stop_gate_verified",
        "maturation_phase": 5,
        "metric_keys": [],
        "known_gaps": ["Upstream context quality still constrains diagnosis, and retries remain intentionally bounded rather than open-ended."],
    },
    {
        "key": "comprehension",
    ...
    },
    {
        "key": "verified_math",
        "name": "Verified Math",
        "responsibility": "Exact bounded arithmetic, units, fractions, ratios, linear equations, introductory geometry, and descriptive statistics with independent result checks.",
        ...
        "maturity_state": "mature_current_scope",
        "target_state": "mature_current_scope",
        "health_state": "phase_5_exact_result_and_independent_check_gate_verified",
        "maturation_phase": 5,
        "metric_keys": [],
        "known_gaps": ["Symbolic algebra beyond one-variable linear equations and advanced mathematics remain unsupported rather than guessed."],
    },
    {
        "key": "source_research",
        ...
        "maturity_state": "mature_current_scope",
        "target_state": "mature_current_scope",
        "health_state": "phase_5_attribution_disagreement_and_citation_gate_verified",
        "maturation_phase": 5,
        "metric_keys": [],
    ...
    },
    {
        ...
        "maturity_state": "mature_current_scope",
        "target_state": "mature_current_scope",
        "health_state": "phase_5_exact_approval_read_only_chat_gate_verified",
        "maturation_phase": 5,
        "metric_keys": [],
        "known_gaps": ["Inspection remains limited to pasted attributed code or exact currently approved workspace files; execution, writes, directories, globs, and autonomous scans remain disabled."],
    },
    {
        "key": "cocoon",
...
EVIDENCE_TESTS_BY_ORGAN: dict[str, tuple[str, ...]] = {
    ...
    "intelligence_os": (
        "tests/test_intelligence_os.py",
        "tests/test_exploratory_reasoning.py",
        "tests/test_bounded_hypothesis.py",
    ),
    "answer_engine": (
        "tests/test_answer_engine.py",
        "tests/test_answer_operations.py",
        "tests/test_answer_ownership.py",
    ),
    "problem_resolution": (
        "tests/test_problem_resolution.py",
    ...
    "source_research": (
        "tests/test_source_backed_research.py",
        "tests/test_research_integrity.py",
    ),
    "local_code": (
        "tests/test_local_code_inspection.py",
        "tests/test_answer_engine.py",
