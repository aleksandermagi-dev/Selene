...
ORGAN_SPECS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "known_gaps": ["Stale correction state and incomplete current-turn fact handoff were observed in ordinary Q&A."],
    },
    {
        "key": "nlo_voice_text",
    ...
    },
    {
        ...
        "source_modules": ["memory_organ.py"],
        "routes": ["memory.index.status", "memory.retrieve"],
        "connection_state": "ordinary_chat",
        "maturity_state": "connected",
        "target_state": "mature_current_scope",
        "health_state": "integration_gap_observed",
        ...
        "known_gaps": ["Retrieval currently begins before canonical turn construction and natural relevance is not broadly evidenced."],
    },
    {
        ...
        "known_gaps": ["Unrelated lessons can still outrank the requested conversational or operational function."],
    },
    {
        "key": "study",
...
EVIDENCE_TESTS_BY_ORGAN: dict[str, tuple[str, ...]] = {
    ...
    "memory": ("tests/test_memory_organ.py",),
...
def organ_maturity_ledger_status(conn: sqlite3.Connection) -> dict[str, Any]:
    ...
    return {
        ...
        "summary": {
            ...
            "next_phase": 1,
            "next_phase_name": "Canonical Context and Coordination Nervous System",
        },
