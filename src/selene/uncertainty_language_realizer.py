...
ACT_CLAUSES: dict[str, tuple[str, ...]] = {
    "state_reference_ambiguity": (
        ...
        "I can follow the sentence, but not which earlier piece it points to",
        "That could refer to more than one thing here",
        "I have the thread, but the specific reference is unclear",
        "I do not want to attach that to the wrong part",
    ),
    "request_reference_grounding": (
        ...
        "Which part of the earlier thread do you mean",
        "Name the piece you are pointing back to and I can reconnect it",
        "Do you mean the first point or the later one",
        "Give me the referent and I can keep going",
    ),
    "state_view_unsettled": (
        ...
        "I have the beginning of a view, but it is not settled",
        "There is a possible answer here, though I am still weighing it",
        "My current read is provisional",
        "I can offer a tentative view, not a firm conclusion",
    ),
    "request_deciding_context": (
        ...
        "What evidence should carry the most weight here",
        "Which criterion do you want the judgment to turn on",
        "Give me the deciding context and I can take a position",
        "What would count as a good answer in this case",
    ),
    "state_missing_ground": (
        ...
        "I can see the question, but I am missing the piece that would decide it",
        "That one is still open from what I have",
        "I could make a guess, but I do not have enough support to call it an answer",
        "I need a little more ground before I can answer honestly",
    ),
    "request_relevant_context": (
        ...
        "What is the key detail I should anchor to",
        "Give me the missing fact and I can take another pass",
        "Which available evidence should I work from",
        "What would you want me to treat as the deciding input",
    ),
    "state_fuzzy_recollection": (
        ...
        "Something feels familiar, but the recall is not sharp enough to state as exact",
        "I have a partial recollection, not a reliable full one",
        "The outline is there, but the details are not clear enough yet",
        "I may recognize the thread without remembering it precisely",
    ),
    "request_memory_grounding": (
        ...
        "Give me one solid detail and I can rebuild around it carefully",
        "Which remembered piece are you most certain of",
        "A date, phrase, or event would give me a clean anchor",
        "What part should we use to reconnect the memory",
    ),
}
