...
CHARTER_LAW_DOCS = (
    "philosophy/PROJECT_CHARTER.md",
    "philosophy/SELENE_TEST_IMPACT_LAW_20260713.md",
    "evidence/SELENE_CHARTER_COMPARISON_20260528.md",
    "philosophy/SELENE_MORAL_COGNITION_LAW_PASS_20260608.md",
    "philosophy/SELENE_ORGAN_NON_IDENTITY_LAW_20260611.md",
    "philosophy/SELENE_PATTERN_FIRST_TRANSFER_SAFETY_20260608.md",
    "architecture/SELENE_MEMORY_ARCHITECTURE_PASS_20260608.md",
    "evidence/SELENE_EVIDENCE_STATUS_UPDATE_20260615.md",
)
STALE_SOFT_DENIAL = (
