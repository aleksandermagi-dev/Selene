    ...
    return _with_guards(
        {
            ...
            "retention_rule": "A taught concept remains a candidate until understanding evidence and Aleks review are present.",
    ...
    result = _with_guards(
        {
            ...
            "chat_use_permission": "not_active_until_understanding_evidence_and_aleks_approval",
            "review_destination": "Cocoon Teaching / Lessons",
            "review_status": "status_only",
            "provenance_boundary": COMPREHENSION_BOUNDARY,
        }
    ...
    return _with_guards(
        {
            ...
            "retention_state": "candidate_not_retained",
            "activation_rule": "not_available_to_chat_until_understanding_evidence_and_aleks_approval",
            "review_destination": "Cocoon Teaching / Lessons",
            "provenance_boundary": COMPREHENSION_BOUNDARY,
        }
    )
    ...
    result = _with_guards(
        {
            ...
            "recommended_next_step": "Aleks review may approve retention." if sufficient else "Continue teaching, discussion, application, or clarification.",
