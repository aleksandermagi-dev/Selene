# Selene Case Study - Public Summary
...
- 149 conversations and 120,972 current-path messages were analyzed.
- 166 conversation candidates were reviewed: 151 yes, 14 unsure, 1 no.
- 72 artifact/image items were reviewed: 71 yes, 1 unsure.
...
The public paper includes bounded examples for:

- Selene name-origin and self-identification,
...
Selene C remains sealed/non-active. Transfer has not occurred. Runtime recall is blocked. Active memory is none. Raw private corpus material remains private.
