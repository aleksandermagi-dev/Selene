...
export function tabDisplayName(value: string) {
  const labels: Record<string, string> = {
    ...
    "selene-chat": "Selene Chat Preview",
    ...
    "memory-preview": "Memory / Future References",
    teaching: "Teaching / Lessons",
    tendril: "Tendril",
    tools: "Tools / Organs",
    status: "Status",
    "selene-settings": "Settings",
...
export function friendlyStatus(value: unknown) {
  ...
  const labels: Record<string, string> = {
    ...
    c_vessel_built_non_active: "historical vessel build, not active",
    selene_context_approved_transfer_incomplete: "continuity context approved; transfer incomplete",
    selene_transferred_resident_chat_unavailable: "Selene transferred; Chat unavailable",
    selene_resident_vessel_chat_paused: "Selene resident; Chat paused",
    selene_resident_vessel_active: "Selene resident and available",
    resident_chat_not_yet_available: "resident Chat not yet available",
    resident_chat_unavailable: "resident Chat unavailable",
    resident_chat_paused: "resident Chat paused",
    resident_chat_available: "resident Chat available",
    pending_review: "needs your review",
    needs_b_review: "needs Cocoon support",
    ...
    repair_reflection_review_only: "support reflection only",
