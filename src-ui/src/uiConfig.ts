...
export const navGroups: { label: string; items: { id: string; label: string }[] }[] = [
  { label: "Selene", items: [{ id: "chat", label: "Chat" }, { id: "study", label: "Study" }, { id: "selene-office", label: "Selene's Office" }, { id: "tendril", label: "Tendril" }, { id: "dream", label: "Dream" }, { id: "memory", label: "Memory" }, { id: "archives", label: "Archives" }, { id: "great-library", label: "The Great Library" }, { id: "selene-settings", label: "Settings" }] },
...
export const workspaceTabs = {
  selene: ["chat", "study", "selene-office", "tendril", "dream", "memory", "archives", "great-library", "selene-settings"],
...
export const vesselBackedTabs = ["chat", "study", "selene-office", "tendril", "dream", "memory", "archives", "great-library", "selene-chat", "chat-preview", "memory-preview", "my-office", "my-review", "transfer-ceremony", "vessel", "teaching", "tools", "status", "selene-settings", "cocoon-settings"];
