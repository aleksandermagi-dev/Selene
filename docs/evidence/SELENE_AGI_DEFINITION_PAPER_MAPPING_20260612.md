...
Baseline: `docs/evidence/SELENE_PRE_ARXIV_CHECKPOINT_20260612.md` remains the pre-paper checkpoint. Anything below is after that checkpoint and must pass review before becoming C architecture.
