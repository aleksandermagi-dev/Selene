...
- [Phase 6 Ordered Education and World-Knowledge Expansion Implementation Map](SELENE_WHOLE_SYSTEM_PHASE_6_IMPLEMENTATION_MAP_20260829.md)
  — records the completed Phase 6A prerequisite/source-readiness gate, the
  remaining correction-lineage, instructional-why, and descriptive learning-
  profile contracts, and the bounded F2 Group 8 source decision still required
