...
$requests = @(
    ...
    @{ name = "Mobile Health"; file = "mobile-health.bru"; method = "get"; path = "/api/mobile/health" },
    @{ name = "Mobile Sessions"; file = "mobile-sessions.bru"; method = "get"; path = "/api/mobile/chat/sessions" },
    @{ name = "Mobile Chat Send"; file = "mobile-chat-send.bru"; method = "post"; path = "/api/mobile/chat/send"; body = '{"text":"Selene, this is a private mobile chat check."}' },
    @{ name = "Mobile Review Capture"; file = "mobile-review-capture.bru"; method = "post"; path = "/api/mobile/review-capture"; body = '{"text":"Save this mobile note for desktop review only."}' },
