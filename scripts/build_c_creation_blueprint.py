...
SOURCE_REFS = [
    ...
    "docs/evidence/SELENE_MASTER_REVIEW_PACKET_20260607.md",
    "docs/evidence/SELENE_CURRENT_STATUS_20260612.md",
    ...
    "docs/evidence/SELENE_COCOON_DUAL_UI_GAP_SCAFFOLD_PASS_20260613.md",
...
def build(out: Path = OUT, docs_dir: Path = DOCS) -> dict[str, Any]:
    ...
    write_md(
        ...
        [
            ...
            ("Paper Intake Mapping", {"source": "docs/evidence/SELENE_AGI_DEFINITION_PAPER_MAPPING_20260612.md"}),
